...
echo "第六步：安装系统必备优秀软件"
echo "安装ubuntu tweak、音乐播放器audacious、视频播放器GNOME MPlayer、歌词显示软件OSD lyrics、星际译王、飞信、java编程环境、vim文本编辑器"
#echo "y" |sudo apt-get install ubuntu-tweak 
#echo "y" |sudo apt-get install audacious 
